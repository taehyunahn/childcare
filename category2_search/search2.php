                            ...
                            <div class="row g-5">
                                ...
                                <div class="col-12">
                                    ...
                                    <!-- <button class="w-100 btn btn-primary btn-lg" type="button"
                                        onClick='location.href="/category2_search/searchResult.php"'>검색</button> -->
                                    ...
                                    <div id="map" style="width:100%;height:700px;margin-top:10px;display:none"></div>
