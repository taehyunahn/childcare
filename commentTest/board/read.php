...
<head>
    <meta charset="UTF-8">
    <title>게시판</title>
    <link rel="stylesheet" type="text/css" href="/commentTest/css/jquery-ui.css" />
    <link rel="stylesheet" type="text/css" href="/commentTest/css/style.css" />
    <script type="text/javascript" src="/commentTest/js/jquery-3.2.1.min.js"></script>
    <script type="text/javascript" src="/commentTest/js/jquery-ui.js"></script>
    <script type="text/javascript" src="/commentTest/js/common.js"></script>
</head>
...
<body>
    ...
    <div id="board_read">
        ...
        <div id="bo_ser">
            <ul>
                <li><a href="/commentTest/index.php">[목록으로]</a></li>
